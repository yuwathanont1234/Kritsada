...
export type ExpoSpeechRecognitionNativeEvents = {
    [K in keyof ExpoSpeechRecognitionNativeEventMap]: (event: ExpoSpeechRecognitionNativeEventMap[K]) => void;
};
...
export {};
//# sourceMappingURL=ExpoSpeechRecognitionModule.types.d.ts.map