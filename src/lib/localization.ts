...
export const translations = {
  en: {
    ...
    settings: {
      ...
      trialActivated: 'Premium 7-day sandbox trial has been started.',
    ...
    membership: {
      ...
      monthly: '/ mo',
      platinumTitle: 'PLATINUM STANDARD',
      goldTitle: 'PRO DEALER GOLD',
      vipTitle: 'PREMIUM EXECUTIVE',
      scanCredits: 'Scan Credit Packages',
      payPerScan: 'PAY-PER-SCAN • Flexible scan top-ups for active collectors',
      oneScanTitle: '1 Scan Credit',
      oneScanDesc: 'Verify dial engraving, date magnifier, caliber finish & value instantly',
      threeScansTitle: '3 Scan Credits',
      threeScansDesc: 'Highly recommended for quick multi-watch inspections',
      tenScansTitle: '10 Scan Credits',
      tenScansDesc: 'The best valuation deal for professional dealers and stores',
      savePercent: 'SAVE {percent}% 🔥',
      buyScan: 'BUY 1 SCAN',
      buyScans: 'BUY {count} SCANS',
      purchaseSuccess: 'Purchase Successful!',
      creditAdded: '{count} Scan credit has been added to your vault.',
    },
    game: {
    ...
    magazine: {
      title: 'Chrono24 Horology Magazine',
  ...
  th: {
    ...
    settings: {
      ...
      startTrial: '🔄 เริ่มทดลองใช้ 7 วัน',
      ...
      trialActivated: 'เปิดใช้งานการทดลองใช้ Premium Sandbox 7 วันเรียบร้อยแล้ว',
    ...
    membership: {
      ...
      monthly: '/ เดือน',
      platinumTitle: 'สแตนดาร์ดแพลทินัม',
      goldTitle: 'โปรดีลเลอร์โกลด์',
      vipTitle: 'พรีเมียมเอ็กเซ็กคิวทีฟ',
      scanCredits: 'แพ็คเกจซื้อสิทธิ์สแกนเพิ่มเติม',
      payPerScan: 'PAY-PER-SCAN • เติมสิทธิ์สแกนแบบยืดหยุ่นสำหรับนักสะสมนาฬิกา',
      oneScanTitle: 'สิทธิ์สแกน 1 ครั้ง',
      oneScanDesc: 'ตรวจสอบการสลักหน้าปัด เลนส์ขยายวันที่ กลไก และราคาตลาดรองได้ทันที',
      threeScansTitle: 'สิทธิ์สแกน 3 ครั้ง',
      threeScansDesc: 'แนะนำเป็นพิเศษสำหรับการสแกนนาฬิกาหลายเรือนพร้อมกันได้อย่างรวดเร็ว',
      tenScansTitle: 'สิทธิ์สแกน 10 ครั้ง',
      tenScansDesc: 'แพ็คเกจราคาประหยัดที่สุดสำหรับดีลเลอร์มืออาชีพและร้านค้านาฬิกาหรู',
      savePercent: 'ประหยัด {percent}% 🔥',
      buyScan: 'ซื้อสแกน 1 ครั้ง',
      buyScans: 'ซื้อสแกน {count} ครั้ง',
    ...
    magazine: {
      title: 'นิตยสารนาฬิกาหรู Chrono24',
