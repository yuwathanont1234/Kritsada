...
export const translations = {
  en: {
    ...
    settings: {
      ...
      wipeData: 'Delete Account & All Data',
      logout: 'Log Out',
      ...
      startTrial: '(DEV) Start 7-Day Trial (5 scans)',
      clearTrial: '❌ Clear Trial',
      wipeConfirmTitle: 'Delete Account & Data',
      wipeConfirmDesc: 'This will permanently delete your account, wipe all vaulted timepiece scans, and clear all private metrics. This action is irreversible.',
      wipeSuccess: 'Your account and all vaulted scan records have been permanently deleted.',
      trialActivated: 'Your Premium 7-day trial (max 5 scans) has started.',
    ...
    game: {
      ...
      quit: 'Return to Hub',
      questionText: 'Can you identify this timepiece?',
      genuineBtn: 'Genuine',
      replicaBtn: 'Replica',
  ...
  th: {
    ...
    settings: {
      ...
      wipeData: 'ลบบัญชีผู้ใช้และข้อมูลทั้งหมด',
      logout: 'ออกจากระบบ',
      language: 'Language / ภาษา',
      english: '🇺🇸 English',
      thai: '🇹🇭 ภาษาไทย',
      ...
      startTrial: '(DEV) เริ่มทดลองใช้ 7 วัน (5 สแกน)',
      clearTrial: '❌ เคลียร์สถานะทดลองใช้',
      wipeConfirmTitle: 'ลบบัญชีและข้อมูลทั้งหมด',
      wipeConfirmDesc: 'สิ่งนี้จะลบบัญชีผู้ใช้ของคุณอย่างถาวร ลบประวัติการสแกนนาฬิกาทั้งหมดในตู้นิรภัย และล้างข้อมูลส่วนบุคคลของคุณทั้งหมด การดำเนินการนี้ไม่สามารถย้อนกลับได้',
      wipeSuccess: 'บัญชีผู้ใช้และข้อมูลประวัติการสแกนทั้งหมดได้รับการลบอย่างถาวรแล้ว',
      trialActivated: 'เริ่มทดลองใช้ Premium ฟรี 7 วัน (สูงสุด 5 สแกน) แล้ว',
    ...
    game: {
      ...
      questionText: 'คุณระบุนาฬิกาเรือนนี้ได้หรือไม่?',
      genuineBtn: 'ของแท้',
      replicaBtn: 'ของปลอม',
    ...
    error: {
      ...
      aiFailed: 'ระบบวิเคราะห์ AI หมดเวลาในการตรวจสอบข้อมูลเมตาดาต้าของตัวเรือน กรุณาถือนิ่งๆ และลองใหม่อีกครั้ง',
